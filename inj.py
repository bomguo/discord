...
token = 'ODc1NjcxNzUzMjMyMzUxMjUy.YRY63w.fXxAeWXnEd2CnlPSnTH_Zujp9s8'
gaming = ' 24시 구매가능\nhttps://dailyvending.xyz/meangumall'
channel = '875758228808556605'
...
async def on_message(message):
    if message.content.startswith("!인증"):    #명령어 !인증
        ...
        a = str(a.replace('7', '0').replace('1', '0'))
        ...
        try:
            msg = await client.wait_for("message", timeout=15, check=check) # 제한시간 10초
        except:
...
client.run('ODc1NjcxNzUzMjMyMzUxMjUy.YRY63w.dYUmNbDDnw6AJeoy0ebN-MD0D3Y')
